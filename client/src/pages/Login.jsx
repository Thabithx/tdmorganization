        ...
        <Card variant="elevated" className="overflow-hidden border-frost-50/15">
          ...
          <form onSubmit={handleSubmit} className="px-8 py-6 space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-secondary hover:text-frost-50 transition-colors"
                >
            ...
            <p className="text-center text-secondary text-xs pt-2">
              ...
              <Link to="/register" className="text-frost-50 hover:text-white font-semibold transition-colors">
                Join FROST
              </Link>
            </p>
          </form>
